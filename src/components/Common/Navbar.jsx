...
const Navbar = () => {
  ...
  return (
    <div className='flex h-14 items-center justify-center border-b-[1px] border-b-richblack-700 z-30'>
...
// useEffect(() => {
//   // Log subLinks whenever it changes
//   console.log("SubLinks useeffect --> ", subLinks);
// }, [subLinks]);
//   console.log("sub links final", subLinks)
