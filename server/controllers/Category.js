...
exports.showAllCategories = async (req, res) => {
  ...
  try {
    console.log("before making all category call");
...
exports.categoryPageDetails = async (req, res) => {
  try {
    ...
    console.log("no error in getting categoryId",categoryId);
    ...
    const selectedCategory = await Category.findById(categoryId)
      ...
      .exec()
    console.log("CatogoryPageDetails Api Hit succesfully!!");
    ...
    console.log("If catogoriesExceptSelected have error than this line will last line..")
    ...
    console.log(":::::::::");
    console.log("Printing All courses -> ",allCourses);
    console.log(":::::::::");
